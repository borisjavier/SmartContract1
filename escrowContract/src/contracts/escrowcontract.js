...
var Escrowcontract = function () {
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function Escrowcontract(addresses, matureTime) {
                ...
                _this.addresses = (__runInitializers(_this, _instanceExtraInitializers), __runInitializers(_this, _addresses_initializers, void 0));
                _this.matureTime = __runInitializers(_this, _matureTime_initializers, void 0);
            ...
            Escrowcontract.prototype.pay = function (signatures, publicKeys) {
                ...
                (0, scrypt_ts_1.assert)(validSigs >= nec, 'not enough valid signatures');
            };
            Escrowcontract.prototype.refundDeadline = function (signatures, publicKeys) {
        ...
        (function () {
            ...
            __esDecorate(_a, null, _pay_decorators, { kind: "method", name: "pay", static: false, private: false, access: { has: function (obj) { return "pay" in obj; }, get: function (obj) { return obj.pay; } }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _refundDeadline_decorators, { kind: "method", name: "refundDeadline", static: false, private: false, access: { has: function (obj) { return "refundDeadline" in obj; }, get: function (obj) { return obj.refundDeadline; } }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(null, null, _addresses_decorators, { kind: "field", name: "addresses", static: false, private: false, access: { has: function (obj) { return "addresses" in obj; }, get: function (obj) { return obj.addresses; }, set: function (obj, value) { obj.addresses = value; } }, metadata: _metadata }, _addresses_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, _matureTime_decorators, { kind: "field", name: "matureTime", static: false, private: false, access: { has: function (obj) { return "matureTime" in obj; }, get: function (obj) { return obj.matureTime; }, set: function (obj, value) { obj.matureTime = value; } }, metadata: _metadata }, _matureTime_initializers, _instanceExtraInitializers);
