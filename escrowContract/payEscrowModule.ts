...
export async function payEscrowContract(params: PayEscrowParams): Promise<PayEscrowResult> {
    ...
    const callWithRetry = async (maxAttempts = 4, initialDelay = 3000): Promise<PayEscrowResult> => {
